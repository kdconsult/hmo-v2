...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .document-title-sub { font-size: 13px; font-weight: bold; color: #374151; }
...
<div class="page">
    ...
    <div class="meta-box">
        <table class="meta">
            <tr>
                <td class="meta-label">Proforma Number:</td>
    ...
    <div class="footer">
        This is a proforma invoice. It is not a VAT invoice and does not create a tax obligation.
    </div>

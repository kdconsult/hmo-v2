...
class SupplierCreditNoteService
{
     ...
     * Requires item->supplierCreditNote and item->vatRate to be loaded (or loadable).
     */
    public function recalculateItemTotals(SupplierCreditNoteItem $item): void
    {
        $pricingMode = $item->supplierCreditNote->pricing_mode;
    ...
    /**
     * Recalculate a supplier credit note's subtotal, tax_amount, and total from its items, then save.
     */
    public function recalculateDocumentTotals(SupplierCreditNote $creditNote): void
    {
